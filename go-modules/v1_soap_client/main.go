...
func clisoap1Handler(w http.ResponseWriter, r *http.Request) {
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
	...
	fmt.Fprint(w, envelope.Body.Response.Result)
}

func main() {
	http.HandleFunc("/clisoap1", clisoap1Handler)
	fmt.Println("Servidor Go V1 corriendo en http://localhost:8000")
