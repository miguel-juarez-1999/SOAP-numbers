...
* **Ruta local:** `node/v1_soap_client/server.js` (Puerto 8000)
* **URL de prueba:** [http://localhost:8000/clisoap1?n=10](http://localhost:8000/clisoap1?n=10)

### Versión 2: Cliente SOAP con Traducción
* **Ruta local:** `node/v2_soap_translation/server.js` (Puerto 8000)
* **URL de prueba:** [http://localhost:8000/clisoap2?n=10](http://localhost:8000/clisoap2?n=10)

### Versión 3: Conversión Local de Número a Letras
* **Ruta local:** `node/v3_local_conversion/server.js` (Puerto 8000)
